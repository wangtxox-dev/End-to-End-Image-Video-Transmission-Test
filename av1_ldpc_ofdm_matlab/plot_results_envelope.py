...
PKL_PATTERN        = 'sim_av1_ofdm_data_20260509_161625.pkl'
...
ax.set_title('AV1 Performance @ Different LDPC rates (OFDM + TDL-C)', fontsize=16)
...
if ONLY_ORIGINAL_CLIFF:
    out_name = f'av1_ofdm_envelope_{timestamp}.png'
else:
    out_name = f'av1_ofdm_envelope_with_JSCC_{timestamp}.png'
