...
从最新的 sim_av1_data_*.pkl 存档中读取仿真数据，绘制各码率曲线及其包络线。
...
ax.set_title('AV1 Performance @ Different LDPC rates', fontsize=16)
...
if ONLY_ORIGINAL_CLIFF:
    out_name = f'av1_envelope_{timestamp}.png'
else:
    out_name = f'av1_envelope_with_JSCC_{timestamp}.png'
